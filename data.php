...
if(isset($_GET['id']))
{
  if($_GET['id'] == '1')
  {
    $sql = "SELECT id, nombre,imagen,precio,condicion,consola FROM articulos order by ventas limit ".$limit;
  }
  else if($_GET['id'] == '2')
  {
  ...
  else if($_GET['id'] == '6')
  {
    ...
    $sql = "SELECT id, nombre,imagen,precio,condicion,consola,descripcion FROM articulos where nombre like "."'%".$busqueda."%'";
